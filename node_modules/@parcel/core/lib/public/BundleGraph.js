...
class BundleGraph {
  ...
  getBundlesInBundleGroup(bundleGroup) {
    return _classPrivateFieldGet(this, _graph).getBundlesInBundleGroup(bundleGroup).sort((a, b) => bundleGroup.bundleIds.indexOf(a.id) - bundleGroup.bundleIds.indexOf(b.id)).map(bundle => new _Bundle.Bundle(bundle, _classPrivateFieldGet(this, _graph), _classPrivateFieldGet(this, _options))).reverse();
  }
  ...
  getParentBundles(bundle) {
    return _classPrivateFieldGet(this, _graph).getParentBundles((0, _Bundle.bundleToInternalBundle)(bundle)).map(bundle => new _Bundle.Bundle(bundle, _classPrivateFieldGet(this, _graph), _classPrivateFieldGet(this, _options)));
  }
  ...
  traverseBundles(visit, startBundle) {
    return _classPrivateFieldGet(this, _graph).traverseBundles((0, _Graph.mapVisitor)(bundle => new _Bundle.Bundle(bundle, _classPrivateFieldGet(this, _graph), _classPrivateFieldGet(this, _options)), visit), startBundle == null ? undefined : (0, _Bundle.bundleToInternalBundle)(startBundle));
  }
